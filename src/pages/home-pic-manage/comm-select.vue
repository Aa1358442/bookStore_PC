...
export default {
  ...
  data () {
    return {
      ...
      tableSelectRows: [],
      columnList: [
        {label: '商品编号', prop: 'goodCode', width: '320'},
        {label: '商品名称', prop: 'goodName'},
        {label: '商品销售数量', prop: 'goodSaleNum'},
        {label: '商品销售价格', prop: 'goodPrice'},
        {label: '商品一级分类', prop: 'goodOneClass'},
        {label: '商品二级分类', prop: 'goodSecClass', width: '160'}
      ]
    }
  },
  watch: {
